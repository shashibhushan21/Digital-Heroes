...
test.describe("Admin controls tabs smoke", () => {
  ...
  test("admin can open each controls tab", async ({ page }) => {
    ...
    const tabAssertions: Array<{ tab: string; heading: string }> = [
      { tab: "Analytics", heading: "Analytics & Reports" },
      { tab: "Users", heading: "User Management" },
      { tab: "Subscriptions", heading: "Subscription Management" },
      { tab: "Scores", heading: "Score Moderation" },
      { tab: "Charities", heading: "Charity Management" },
      { tab: "Draws", heading: "Draw Operations" },
      { tab: "Winners", heading: "Winner Management" },
      { tab: "Notifications", heading: "Notification Queue" },
    ];

    for (const item of tabAssertions) {
